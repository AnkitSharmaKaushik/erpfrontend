...
import { AddManDaysColumn } from "./AddManDaysColumn";
import { AddManDaysData } from "./AddManDaysData";

const AddManDaysTable = () => {
  const columns = AddManDaysColumn();
  const data = AddManDaysData();
...
export default AddManDaysTable;
