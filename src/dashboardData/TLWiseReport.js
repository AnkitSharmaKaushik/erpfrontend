...
import ExportCSV from "../project/exportProjectData/ExportExcel";
...
const TLWiseReport = ({
  ...
  return (
    <div className="overflow-x-auto no-scrollbar max-h-[450px] h-full overflow-scroll">
