...
export const AbrProjectTableData = () => {
  ...
  const data = useMemo(() => {
    ...
    filteredData = filteredData.filter((item) => {
      return item.status === abrActiveTabs;
    });
