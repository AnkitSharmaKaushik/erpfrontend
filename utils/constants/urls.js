...
export const PROJECTDATAAPIS = (page_number, page_size, activeTabs) => {
  if (!page_number) {
...
export const PROJECTENTRYAPIS = BASEURL + "/api/project/projects/";
export const NOTIFICATIONCOUNT = BASEURL + "/api/project/notifications/count/";

export const GETCBRSINGLEPROJECT = (id) => {
  if (!id) {
    throw new Error("ID is required to raised CBR!!");
  }
  return `${BASEURL}/api/finance/project-cbr-data/${id}/`;
};
export const GETABRSINGLEPROJECT = (id) => {
  if (!id) {
    throw new Error("ID is required to raised CBR!!");
  }
  return `${BASEURL}/api/finance/abr/${id}/`;
};
export const ABRPROJECTLIST = BASEURL + "/api/finance/abr/project-list/";
export const CBRPROJECTLIST = BASEURL + '/api/finance/cbr/project-list/';
export const CREATEADVANCEPAYMENT = BASEURL + '/api/finance/abr/create/';
