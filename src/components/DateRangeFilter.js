...
const DateRangeFilter = ({ dateRange, setDateRange }) => {
  ...
  const resetDate = () => {
    ...
    dispatch(addStartDateRange(null));
    dispatch(addEndDateRange(null));
  ...
  const setLastWeek = () => {
    ...
    dispatch(addStartDateRange(startOfLastWeek?._d?.toISOString()));
    dispatch(addEndDateRange(endOfLastWeek?._d?.toISOString()));
  ...
  const setLast7Days = () => {
    ...
    dispatch(addStartDateRange(startOfLast7Days?._d?.toISOString()));
    dispatch(addEndDateRange(endOfLast7Days?._d?.toISOString()));
  ...
  const setCurrentMonth = () => {
    ...
    dispatch(addStartDateRange(startOfCurrentMonth?._d?.toISOString()));
    dispatch(addEndDateRange(endOfCurrentMonth?._d?.toISOString()));
  ...
  const setPrevMonth = () => {
    ...
    dispatch(addStartDateRange(startOfPrevMonth?._d?.toISOString()));
    dispatch(addEndDateRange(endOfPrevMonth?._d?.toISOString()));
