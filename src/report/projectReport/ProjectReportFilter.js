...
import useClientList from "../../../utils/hooks/useClientList";
import {
  addSearchText,
  toggleIsOpenFilterDrawer,
} from "../../../utils/slices/filterSlice";
import { setProjects } from "../../../utils/slices/projectSlice";
import ProjectReportFilterDrawer from "./ProjectReportFilterDrawer";
...
const ProjectReportFilter = () => {
  ...
  return (
    <div className="flex items-center">
      ...
      {openFilterDrawer && <ProjectReportFilterDrawer />}
    </div>
  );
};
