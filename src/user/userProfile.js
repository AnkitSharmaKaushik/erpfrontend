...
export const Profile = ({ profileDataUpdate }) => {
  ...
  return (
    <div className="bg-white rounded-none p-4 mt-16">
          ...
          <div className="lg:flex lg:flex-row flex-col items-center justify-around">
              ...
              {profileDetails?.profile_picture !== null ? (
                <div className="relative">
                  <img
                    ...
                    className="lg:w-40 lg:h-40 w-20 h-20 rounded-none bg-cover"
                  />
                  {profileDetails?.profile_picture && (
                    <MdOutlineModeEdit
                      className={
                        "absolute bottom-0 left-24 bg-gray-100 rounded-none p-2 w-8 h-8 cursor-pointer"
                      }
                      onClick={""}
                    />
                  )}
                ...
                <FaRegUserCircle className="lg:w-40 lg:h-40 w-20 h-20 rounded-none bg-cover" />
              )}
            ...
            <div className="w-6/12 flex flex-col lg:gap-4 gap-3 p-3 lg:p-4 mt-8">
              ...
              <Input
                ...
                name={"phone"}
                className={
                  "outline-none p-2 pl-4 border bg-[#f3eded] rounded-none focus:border-cyan-600 relative w-full"
                }
                required={"required"}
              ...
              <Dropdown
                className={
                  "outline-none p-2 pl-4 border bg-[#f3eded] rounded-none focus:border-cyan-600 relative w-full pr-4"
                }
              ...
              <div className="flex justify-center pt-4">
                <Button
                  className={
                    "p-4 bg-green-300 w-1/2 rounded-none text-white hover:bg-green-600"
                  }
                  name={"Update"}
                ...
                <Button
                  className={
                    "p-4 bg-[#e7251e] w-1/2 rounded-none text-white ml-2"
                  }
                  name={"Cancel"}
