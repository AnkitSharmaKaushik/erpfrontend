...
const CreateAbrInvoice = () => {
  ...
  return (
    <div className="p-8 w-full max-w-5xl mx-auto bg-gradient-to-br from-blue-100 to-blue-300 shadow-2xl rounded-3xl relative overflow-hidden">
      {/* Invoice Header */}
...
export default CreateAbrInvoice;
